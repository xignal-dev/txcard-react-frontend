...
const RegisterForm = ({ setState }) => {
  ...
  return (
    <HomeContainer>
      ...
      <TopContainer>
        <c.BigText>{'받으신 카드를 등록하고 사용하세요'}</c.BigText>
        ...
        <CardReqBox>
          ...
          <RightBox>
            ...
            <TextBox style={{ display: 'flex', flexDirection: 'column', width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start', marginTop: '40px' }}>
              <c.LargeText style={{ fontSize: '28px' }}>{'카드 신청인'}</c.LargeText>
              <c.NormalText style={{ fontSize: '24px' }}>{'ema***@gmail.com'}</c.NormalText>
            </TextBox>

            <ContentBox style={{ display: 'flex', flexDirection: 'column', width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start', marginTop: '40px' }}>

              <c.LargeText style={{ fontSize: '28px' }}>{'카드번호'}</c.LargeText>
              <CardNumBox style={{ marginTop: '7px' }}>
